...
The computational domain consists of a **supersonic crossflow over a jet injector**, as shown in the figure. The **mesh is a nonuniform structured grid** created using **Pointwise**, with finer resolution near the fuel inlet to accurately capture the interaction between the jet and the supersonic crossflow. Additionally, this fine grid resolution is maintained **70 mm upstream** of the fuel inlet to correctly resolve **boundary layer separation** and ensure accurate shock capturing.  

<p align="center">
  <img src="https://sachdevakunal.github.io/images/jisc/geometry.png" width="75%">
</p>
...
<p align="center">
  <img src="https://sachdevakunal.github.io/images/jisc/mesh.png" width="75%">
</p>
...
- **Inlet:** Supersonic inflow (prescribed flow properties from freestream conditions)  
- **Outlet:** Supersonic pressure outlet (allowing shock interactions to propagate without reflection)  

For the **solver setup**, a **steady-state** simulation is performed using the **k-omega SST turbulence model** under **non-reacting flow conditions**. The key convergence criteria include:  
